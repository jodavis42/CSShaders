...
void Main(OpImageFetchTest self)
{
    ...
    vector4Val = texelFetch(SPIRV_Cross_CombinedFloatImage2dValSPIRV_Cross_DummySampler, integer2Val, 0);
    vector4Val = texelFetch(FloatSampledImage2dVal, integer2Val, 0);
}
