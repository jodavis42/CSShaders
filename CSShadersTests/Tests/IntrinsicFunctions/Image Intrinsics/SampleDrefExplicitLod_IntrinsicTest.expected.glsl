...
void OpImageSampleDrefExplicitLodTest_InitGlobals()
{
}
...
void OpImageSampleDrefExplicitLodTest_CopyInputs(OpImageSampleDrefExplicitLodTest self)
{
}
...
void OpImageSampleDrefExplicitLodTest_CopyOutputs(OpImageSampleDrefExplicitLodTest self)
{
}

void main()
{
    OpImageSampleDrefExplicitLodTest_InitGlobals();
    OpImageSampleDrefExplicitLodTest self;
    OpImageSampleDrefExplicitLodTest_DefaultConstructor(self);
    OpImageSampleDrefExplicitLodTest_CopyInputs(self);
    Main(self);
    OpImageSampleDrefExplicitLodTest_CopyOutputs(self);
}
